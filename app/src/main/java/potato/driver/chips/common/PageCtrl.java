package potato.driver.chips.common;
...
import potato.driver.chips.app.WebViewActivity;
import potato.driver.data.bean.JiongtuAlbum;
import potato.driver.ui.jiongtu.JiongTuDetailActivity;
import potato.driver.ui.login.LoginActivity;
...
public class PageCtrl {
    ...
    */
    ...
    public static void start2Login(Context context){
        Bundle bundle = new Bundle();
        start(context,LoginActivity.class,false,"",bundle);
    }
