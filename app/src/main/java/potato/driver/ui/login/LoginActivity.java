package potato.driver.ui.login;
...
import potato.driver.data.parser.DriverLoginParser;
    ...
    private void doLogin(String email, String password) {
        ...
        RequestManager.requestData(requestWraper, new RequestManager.DataLoadListener() {
            ...
            public void onSuccess(int statusCode, String content) {
                showProgress(false);
                DriverLoginParser parser = new DriverLoginParser(content);
                if (parser.isSucc()) {
                    Toast.makeText(LoginActivity.this, "succ", Toast.LENGTH_LONG).show();
                    DriverBeanDao dao = new DriverBeanDao(getApplication());
                    parser.bean.setIslogin("1");
                    dao.insert(parser.bean);
                    finish();
                } else {
